...
{% set result =set_table_name('klaviyo_segments_tbl_ptrn','%klaviyo%segments','klaviyo_segments_tbl_exclude_ptrn','') %}
...
{% for i in result %}
        ...
        {{timezone_conversion("attributes.value:updated")}} as _edm_eff_strt_ts,
        {% else %}
